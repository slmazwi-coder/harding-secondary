...
export const StudentLogin = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // NOTE: Demo portal uses client-side session state only.
    sessionStorage.setItem('harding_student_portal_student_number', sn);
    navigate('/student');
  };
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md border border-gray-700">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Harding Secondary School</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-school-primary text-white py-3 rounded-xl font-bold hover:bg-green-800 transition-colors"
          >
            Sign In
          </button>
        </form>
