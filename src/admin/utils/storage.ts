...
const defaultStaff: StaffMember[] = [
  { name: 'TE Laurence', position: 'Principal', categories: ['School Management'], image: '/assets/staff/principal.jpg?v=2' },
  { name: 'AP Msizazwe', position: 'Deputy Principal', subject: 'Physical Sciences', categories: ['School Management', 'Subject Teachers'], image: '/assets/staff/ap-msizazwe.jpg?v=2' },
  { name: 'A Vally', position: 'Deputy Principal', subject: 'Natural Sciences', categories: ['School Management', 'Subject Teachers'], image: '/assets/staff/a-vally.jpg?v=2' },
{ name: 'LS Bishop', position: 'Departmental Head', subject: 'Mathematics', categories: ['School Management', 'Subject Teachers'], departmentHead: 'Mathematics & Mathematical Literacy', image: '/assets/staff/ls-bishop.jpg?v=2' },
  { name: 'P Govender', position: 'Departmental Head', subject: 'Tourism', categories: ['School Management', 'Subject Teachers'], departmentHead: 'Humanities', image: '/assets/staff/p-govender.jpg?v=2' },
  ...
  { name: 'SC Mkhize', position: 'Departmental Head', subject: 'Accounting', categories: ['School Management', 'Subject Teachers'], departmentHead: 'Commerce', image: '/assets/staff/sc-mkhize.jpg?v=2' },
  { name: 'NS Sigwebela', position: 'Departmental Head', subject: 'Life Sciences', categories: ['School Management', 'Subject Teachers'], departmentHead: 'Sciences', image: '/assets/staff/ns-sigwebela.jpg?v=2' },
  { name: 'XP Dayi', position: 'Educator', subject: 'Computer Applications Technology', categories: ['Subject Teachers'], image: '/assets/staff/xp-dayi.jpg?v=2' },
  { name: 'PP Dickens', position: 'Educator', subject: 'English Home Language', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '11D', room: 'O14', image: '/assets/staff/pp-dickens.jpg?v=2' },
  { name: 'SE Dlamini', position: 'Educator', subject: 'Mathematical Literacy', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '10F', room: 'C8', image: '/assets/staff/se-dlamini.jpg?v=2' },
  { name: 'P Fundzo', position: 'Educator', subject: 'Life Sciences', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '12A', room: 'O11', image: '/assets/staff/p-fundzo.jpg?v=2' },
  { name: 'K Gana', position: 'Educator', subject: 'Tourism', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '11C', room: 'O13', image: '/assets/staff/k-gana.jpg?v=2' },
  { name: 'CB Grimett', position: 'Educator', subject: 'History', categories: ['Subject Teachers'], image: '/assets/staff/cb-grimett.jpg?v=2' },
  { name: 'AC Gumede', position: 'Educator', subject: 'Mathematical Literacy', categories: ['Subject Teachers'] },
  { name: 'LH Kheswa', position: 'Educator', subject: 'Life Sciences', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '10D', room: 'B7' },
  { name: 'M Lukhozi', position: 'Educator', subject: 'Life Orientation', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '12C', room: 'O2/O3', image: '/assets/staff/m-lukhozi.jpg?v=2' },
  { name: 'N Madikizela', position: 'Educator', subject: 'English First Additional Language', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '8B', room: 'B6', image: '/assets/staff/n-madikizela.jpg?v=2' },
  { name: 'LT Malishe', position: 'Educator', subject: 'Geography', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '12B', room: 'O4', image: '/assets/staff/lt-malishe.jpg?v=2' },
  { name: 'Y Mbuzi', position: 'Educator', subject: 'Mathematics', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '10A', room: 'C1', image: '/assets/staff/y-mbuzi.jpg?v=2' },
  { name: 'BP Mdleko', position: 'Educator', subject: 'Mathematics', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '9C', room: 'A5', image: '/assets/staff/bp-mdleko.jpg?v=2' },
  { name: 'A Mdunjane', position: 'Educator', subject: 'isiZulu First Additional Language', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '8A', room: 'P6', image: '/assets/staff/a-mdunjane.jpg?v=2' },
  { name: 'A Mgcinwa', position: 'Educator', subject: 'Economics', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '8C', room: 'P5', image: '/assets/staff/a-mgcinwa.jpg?v=2' },
  { name: 'O Mgcwaba', position: 'Educator', subject: 'Physical Sciences', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '10B', room: 'C5', image: '/assets/staff/o-mgcwaba.jpg?v=2' },
  { name: 'NS Mhlongo', position: 'Educator', subject: 'Business Studies', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '8E', room: 'B20', image: '/assets/staff/ns-mhlongo.jpg?v=2' },
  { name: 'S Mjwara', position: 'Educator', subject: 'isiZulu First Additional Language', categories: ['Subject Teachers'] },
  { name: 'S Mkhize', position: 'Educator', subject: 'Afrikaans First Additional Language', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '8F', room: 'P3', image: '/assets/staff/s-mkhize.jpg?v=2' },
  { name: 'A Mkize', position: 'Educator', subject: 'English Home Language', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '8G', room: 'P2', image: '/assets/staff/a-mkize.jpg?v=2' },
  { name: 'AP Mlambo', position: 'Educator', subject: 'Geography', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '11A', room: 'O12', image: '/assets/staff/ap-mlambo.jpg?v=2' },
  { name: 'M Mthembu', position: 'Educator', subject: 'History', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '9E', room: 'A1', image: '/assets/staff/m-mthembu.jpg?v=2' },
  { name: 'A Mtolo', position: 'Educator', subject: 'Afrikaans First Additional Language', categories: ['Subject Teachers'], image: '/assets/staff/a-mtolo.jpg?v=2' },
  { name: 'E Musariri', position: 'Educator', subject: 'Mathematical Literacy', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '11E', room: 'P4', image: '/assets/staff/e-musariri.jpg?v=2' },
  { name: 'N Mvundla', position: 'Educator', subject: 'English Home Language', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '12E', room: 'Resource Centre', image: '/assets/staff/n-mvundla.jpg?v=2' },
  { name: 'B Ndabani', position: 'Educator', subject: 'Mathematics', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '9A', room: 'A3', image: '/assets/staff/b-ndabani.jpg?v=2' },
  { name: 'K Ndlwana', position: 'Educator', subject: 'Natural Sciences', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '9D', room: 'A4', image: '/assets/staff/k-ndlwana.jpg?v=2' },
  { name: 'JB Nkonza-Grimett', position: 'Educator', subject: 'Life Orientation', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '9B', room: 'A2', image: '/assets/staff/jb-nkonza-grimett.jpg?v=2' },
  { name: 'DS Ntshangase', position: 'Educator', subject: 'Mathematics', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '9F', room: 'A6', image: '/assets/staff/ds-ntshangase.jpg?v=2' },
  { name: 'M Shabangu', position: 'Educator', subject: 'English Home Language', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '11B', room: 'PP1', image: '/assets/staff/m-shabangu.jpg?v=2' },
  { name: 'MR Sikhosane', position: 'Educator', subject: 'isiZulu Home Language', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '12D', room: 'Old Lab', image: '/assets/staff/mr-sikhosane.jpg?v=2' },
  { name: 'TA Swartling', position: 'Educator', subject: 'English Home Language', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '10E', room: 'C6', image: '/assets/staff/ta-swartling.jpg?v=2' },
  { name: 'P Wetshe', position: 'Educator', subject: 'Technology', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '9G', room: 'C7', image: '/assets/staff/p-wetshe.jpg?v=2' },
  { name: 'S Xaba', position: 'Educator', subject: 'Consumer Studies', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '8D', room: 'B18', image: '/assets/staff/s-xaba.jpg?v=2' },
  { name: 'V Zithutha', position: 'Educator', subject: 'Business Studies', categories: ['Subject Teachers', 'Class Teachers'], classTeacherFor: '10C', room: 'O10', image: '/assets/staff/v-zithutha.jpg?v=2' },
  { name: 'M Jackson', position: 'Supervisor: Support Staff', categories: ['Support Staff'], supportOrder: 1, image: '/assets/staff/m-jackson.jpg?v=2' },
  { name: 'L Govender', position: 'Administration Staff', categories: ['Support Staff'], supportOrder: 2, image: '/assets/staff/l-govender.jpg?v=2' },
];
