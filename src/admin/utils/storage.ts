...
{ name: 'LS Bishop', position: 'Departmental Head', subject: 'Mathematics', categories: ['School Management', 'Subject Teachers'], departmentHead: 'Mathematics & Mathematical Literacy', image: '/assets/staff/ls-bishop.jpg?v=2' },
  ...
  { name: 'PP Dickens', position: 'Educator', subject: 'English Home Language', categories: ['Subject Teachers'], image: '/assets/staff/pp-dickens.jpg?v=2' },
  { name: 'SE Dlamini', position: 'Educator', subject: 'Mathematical Literacy', categories: ['Subject Teachers'], image: '/assets/staff/se-dlamini.jpg?v=2' },
  { name: 'P Fundzo', position: 'Educator', subject: 'Life Sciences', categories: ['Subject Teachers'], image: '/assets/staff/p-fundzo.jpg?v=2' },
  { name: 'K Gana', position: 'Educator', subject: 'Tourism', categories: ['Subject Teachers'], image: '/assets/staff/k-gana.jpg?v=2' },
  ...
  { name: 'M Lukhozi', position: 'Educator', subject: 'Life Orientation', categories: ['Subject Teachers'], image: '/assets/staff/m-lukhozi.jpg?v=2' },
  { name: 'N Madikizela', position: 'Educator', subject: 'English First Additional Language', categories: ['Subject Teachers'], image: '/assets/staff/n-madikizela.jpg?v=2' },
  { name: 'LT Malishe', position: 'Educator', subject: 'Geography', categories: ['Subject Teachers'], image: '/assets/staff/lt-malishe.jpg?v=2' },
  { name: 'Y Mbuzi', position: 'Educator', subject: 'Mathematics', categories: ['Subject Teachers'], image: '/assets/staff/y-mbuzi.jpg?v=2' },
  { name: 'BP Mdleko', position: 'Educator', subject: 'Mathematics', categories: ['Subject Teachers'], image: '/assets/staff/bp-mdleko.jpg?v=2' },
  { name: 'A Mdunjane', position: 'Educator', subject: 'isiZulu First Additional Language', categories: ['Subject Teachers'], image: '/assets/staff/a-mdunjane.jpg?v=2' },
  { name: 'A Mgcinwa', position: 'Educator', subject: 'Economics', categories: ['Subject Teachers'], image: '/assets/staff/a-mgcinwa.jpg?v=2' },
  { name: 'O Mgcwaba', position: 'Educator', subject: 'Physical Sciences', categories: ['Subject Teachers'], image: '/assets/staff/o-mgcwaba.jpg?v=2' },
  { name: 'NS Mhlongo', position: 'Educator', subject: 'Business Studies', categories: ['Subject Teachers'], image: '/assets/staff/ns-mhlongo.jpg?v=2' },
  { name: 'S Mjwara', position: 'Educator', subject: 'isiZulu First Additional Language', categories: ['Subject Teachers'] },
  { name: 'S Mkhize', position: 'Educator', subject: 'Afrikaans First Additional Language', categories: ['Subject Teachers'], image: '/assets/staff/s-mkhize.jpg?v=2' },
  { name: 'A Mkize', position: 'Educator', subject: 'English Home Language', categories: ['Subject Teachers'], image: '/assets/staff/a-mkize.jpg?v=2' },
  { name: 'AP Mlambo', position: 'Educator', subject: 'Geography', categories: ['Subject Teachers'], image: '/assets/staff/ap-mlambo.jpg?v=2' },
  { name: 'M Mthembu', position: 'Educator', subject: 'History', categories: ['Subject Teachers'], image: '/assets/staff/m-mthembu.jpg?v=2' },
  ...
  { name: 'E Musariri', position: 'Educator', subject: 'Mathematical Literacy', categories: ['Subject Teachers'], image: '/assets/staff/e-musariri.jpg?v=2' },
  { name: 'N Mvundla', position: 'Educator', subject: 'English Home Language', categories: ['Subject Teachers'], image: '/assets/staff/n-mvundla.jpg?v=2' },
  { name: 'B Ndabani', position: 'Educator', subject: 'Mathematics', categories: ['Subject Teachers'], image: '/assets/staff/b-ndabani.jpg?v=2' },
  { name: 'K Ndlwana', position: 'Educator', subject: 'Natural Sciences', categories: ['Subject Teachers'], image: '/assets/staff/k-ndlwana.jpg?v=2' },
  { name: 'JB Nkonza-Grimett', position: 'Educator', subject: 'Life Orientation', categories: ['Subject Teachers'], image: '/assets/staff/jb-nkonza-grimett.jpg?v=2' },
  { name: 'DS Ntshangase', position: 'Educator', subject: 'Mathematics', categories: ['Subject Teachers'], image: '/assets/staff/ds-ntshangase.jpg?v=2' },
  { name: 'M Shabangu', position: 'Educator', subject: 'English Home Language', categories: ['Subject Teachers'], image: '/assets/staff/m-shabangu.jpg?v=2' },
  { name: 'MR Sikhosane', position: 'Educator', subject: 'isiZulu Home Language', categories: ['Subject Teachers'], image: '/assets/staff/mr-sikhosane.jpg?v=2' },
  { name: 'TA Swartling', position: 'Educator', subject: 'English Home Language', categories: ['Subject Teachers'], image: '/assets/staff/ta-swartling.jpg?v=2' },
  { name: 'P Wetshe', position: 'Educator', subject: 'Technology', categories: ['Subject Teachers'], image: '/assets/staff/p-wetshe.jpg?v=2' },
  { name: 'S Xaba', position: 'Educator', subject: 'Consumer Studies', categories: ['Subject Teachers'], image: '/assets/staff/s-xaba.jpg?v=2' },
  { name: 'V Zithutha', position: 'Educator', subject: 'Business Studies', categories: ['Subject Teachers'], image: '/assets/staff/v-zithutha.jpg?v=2' },
