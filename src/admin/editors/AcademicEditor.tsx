...
import { Plus, Trash2, Save, X, ImageIcon, Pencil, ShieldCheck, Loader2, BookOpenText as ActivityIcon } from 'lucide-react';

const categories = ['Academic', 'Culture'];
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          onClick={() => {
            setEditing({ id: Date.now().toString(), name: '', description: '', category: categories[0], image: '' });
            setIsNew(true);
          }}
