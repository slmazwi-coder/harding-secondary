      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-2xl font-bold mb-6">Harding Secondary School</h3>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-green-100 text-sm">
          <p>© {new Date().getFullYear()} Harding Secondary School. All Rights Reserved. | Porro Pergite — Ever Forward</p>
          <Link to="/admin/login" className="text-green-200/30 hover:text-green-100/60 text-xs mt-2 inline-block transition-colors">Staff Portal</Link>
        </div>
      </div>
    </footer>
  );
